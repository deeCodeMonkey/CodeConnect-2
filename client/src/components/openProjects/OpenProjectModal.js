    ...
    render() {
        return (
            <Modal
                ...
                <button className="btn btn-default" onClick={this.onClickHandler}>Add Project to User</button>
                <button className="btn btn-default right" onClick={this.props.closeModal}>Close</button>
